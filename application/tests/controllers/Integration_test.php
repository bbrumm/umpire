...
ORDER BY ag.display_order ASC, d.division_name ASC;";
        ...
        $expectedArray = array(
            ...
            array('age_group'=>'Under 18', 'division_name'=>'Div 1'),
            array('age_group'=>'Under 18', 'division_name'=>'Div 2'),
            array('age_group'=>'Under 18', 'division_name'=>'Div 3'),
            array('age_group'=>'Under 18', 'division_name'=>'Div 4'),
            array('age_group'=>'Under 18', 'division_name'=>'Div 5'),
            array('age_group'=>'Under 18', 'division_name'=>'Div 6'),
            array('age_group'=>'Under 18', 'division_name'=>'Div 7'),
            array('age_group'=>'Under 18', 'division_name'=>'Grading'),
...
ORDER BY v.id;";
        ...
        $expectedArray = array(
            ...
            array('region'=>'Geelong', 'league'=>'GJFL', 'age_group'=>'Under 18')
        );
        foreach ($expectedArray as $key=>$subArray) {
