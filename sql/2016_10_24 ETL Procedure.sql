...
/*Insert new GROUND records where they don't exist*/
...
short_league_name, age_group_id, age_group, umpire_type_name, season_id, match_played_id)
...
INSERT INTO mv_report_02 (season_year, full_name, umpire_type_name, short_league_name, age_group,  
      ...
      SELECT season_year,  
            ...
            d1.umpire_full_name,  
            COUNT(d1.match_played_ID) AS match_count  
            ...
            '2 Umpires',  
            d1.umpire_full_name,  
            COUNT(d1.match_played_ID)  
            FROM mv_denormalised d1
            INNER JOIN ( 
				SELECT   
				d2.season_year, 
				d2.match_played_ID,  
				COUNT(d2.umpire_ID) AS umpire_count  
...
LEFT OUTER JOIN mv_report_06_staging s ON u1.umpire_name = s.first_umpire AND u2.umpire_name = s.second_umpire AND u1.season_year = s.season_year
